        ...
        implements HeapDataChangeListener<HeapEntry>
{
    ...
    {
        if (isCompact(heapBlockBuilder.getSizeInBytes(), heapBlockBuilder.getPositionCount())) {
            compact();
        }
        else {
    ...
    protected boolean isCompact(long sizeInBytes, int numberOfPositionInBlock)
    {
