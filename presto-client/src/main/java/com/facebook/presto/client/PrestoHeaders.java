...
public final class PrestoHeaders
{
    ...
    public static final String PRESTO_REQUEST_PAGE_BACKUP = "X-Presto-Request-Page-Backup";
    ...
    public static final String PRESTO_GRACEFUL_SHUTDOWN = "X-Presto-Graceful-Shutdown";
